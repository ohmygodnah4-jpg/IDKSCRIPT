...
Background = Color3.fromRGB(28, 20, 32),
Topbar = Color3.fromRGB(40, 30, 50),
Shadow = Color3.fromRGB(18, 12, 22),

NotificationBackground = Color3.fromRGB(32, 22, 35),
NotificationActionsBackground = Color3.fromRGB(255, 220, 200),

TabBackground = Color3.fromRGB(90, 60, 70),
TabStroke = Color3.fromRGB(110, 80, 90),
TabBackgroundSelected = Color3.fromRGB(255, 160, 110),
TabTextColor = Color3.fromRGB(255, 230, 215),
SelectedTabTextColor = Color3.fromRGB(55, 30, 25),

ElementBackground = Color3.fromRGB(45, 30, 50),
ElementBackgroundHover = Color3.fromRGB(55, 35, 60),
SecondaryElementBackground = Color3.fromRGB(35, 25, 40),
ElementStroke = Color3.fromRGB(80, 60, 75),
SecondaryElementStroke = Color3.fromRGB(70, 50, 65),

SliderBackground = Color3.fromRGB(255, 140, 90),
SliderProgress = Color3.fromRGB(255, 110, 70),
SliderStroke = Color3.fromRGB(255, 160, 120),

ToggleBackground = Color3.fromRGB(40, 30, 40),
ToggleEnabled = Color3.fromRGB(255, 120, 80),
ToggleDisabled = Color3.fromRGB(130, 130, 130),
ToggleEnabledStroke = Color3.fromRGB(255, 150, 120),
ToggleDisabledStroke = Color3.fromRGB(150, 150, 150),
ToggleEnabledOuterStroke = Color3.fromRGB(110, 80, 70),
ToggleDisabledOuterStroke = Color3.fromRGB(80, 80, 80),

DropdownSelected = Color3.fromRGB(55, 40, 50),
DropdownUnselected = Color3.fromRGB(40, 30, 40),

InputBackground = Color3.fromRGB(40, 30, 40),
InputStroke = Color3.fromRGB(85, 60, 75),
PlaceholderColor = Color3.fromRGB(210, 180, 170)
